...
module.exports = function(opts, cb) {
  ...
  var getListCards = function(listId, cb) {
      ...
      request(uri, function(error, resp, body) {
        ...
        var cards, checklistItems;
        try {
          cards = JSON.parse(body);

          var clCount = cards.reduce(function(prev, curr, ix, array) {
  ...
  var getChecklistItems = function(checklistId, cb) {
    ...
    request(checklistUri, function(error, resp, clBody) {
      if(error) { 
        console.warn("Checklist request returned error");
        return cb([]);
      }
      try {
        ...
        console.warn("Caught error in getChecklistItems");
        return cb([]);
      }
    });
  };
